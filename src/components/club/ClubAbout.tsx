  ...
  return <Card className="border-navy-DEFAULT/30 dark:border-navy-light/50 bg-white dark:bg-navy-400 shadow-md">
      <CardContent className="p-6 bg-navy-400">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          {specialties.map((specialty, index) => <Badge key={index} variant="outline" className="bg-gray-50 dark:bg-navy-300 border-navy-DEFAULT/30 dark:border-navy-light text-navy-dark dark:text-white">
              {specialty}
            </Badge>)}
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          {facilities.map((facility, index) => <Badge key={index} variant="outline" className="bg-gray-50 dark:bg-navy-300 border-navy-DEFAULT/30 dark:border-navy-light text-navy-dark dark:text-white">
              {facility}
            </Badge>)}
        </div>
      </CardContent>
