  ...
  if (tab === "info") {
    return <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="rounded-lg p-5 shadow-sm border border-gray-200 dark:border-navy-300" style={{backgroundColor: "hsl(var(--navy-card-bg-500))"}}>
            <ClubAbout club={club} specialties={details.specialties} facilities={details.facilities} />
          </div>
          
          <div className="rounded-lg p-5 shadow-sm border border-gray-200 dark:border-navy-300" style={{backgroundColor: "hsl(var(--navy-card-bg-200))"}}>
            <ClubMembership membershipFee={details.membershipFee} waitTime={details.membershipWaitTime} className="" />
          </div>
