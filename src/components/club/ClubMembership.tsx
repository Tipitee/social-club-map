...
const ClubMembership: React.FC<ClubMembershipProps> = ({ membershipFee, waitTime }) => {
  return (
    <Card className="border-navy-DEFAULT dark:border-navy-light bg-white dark:bg-navy-400 shadow-md">
      <CardContent className="p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="pt-4">
            <Button 
              className="w-full bg-teal-DEFAULT hover:bg-teal-dark text-white font-medium py-2 h-auto"
              variant="teal"
            >
