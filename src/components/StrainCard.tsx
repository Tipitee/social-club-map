...
const StrainCard: React.FC<StrainCardProps> = ({
  ...
  const getTypeColor = () => {
    switch (strain.type) {
      case "Indica":
        return "bg-strain-indica text-white";
      case "Sativa":
        return "bg-strain-sativa text-white";
      case "Hybrid":
      default:
        return "bg-strain-hybrid text-white";
    }
  };
    ...
    <div className="strain-card h-full">
      <div className="relative h-48 overflow-hidden group">
        {strain.img_url ? (
          ...
          <div className="w-full h-full flex items-center justify-center backdrop-blur-sm rounded-md bg-ashGray-500">
            {getTypeIcon()}
          </div>
        )}
      ...
      <div className="p-5 bg-white dark:bg-navy-dark">
        ...
        <div className="h-6 flex items-center">
          {strain.most_common_terpene ? (
            <div className="flex items-center">
              ...
              <Badge variant="outline" className="font-medium text-xs border-gray-300 dark:border-navy-light text-navy-dark dark:text-gray-200">
                {strain.most_common_terpene}
              </Badge>
            </div>
          ) : (
