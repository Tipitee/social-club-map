    ...
    return <div className="min-h-screen bg-linen dark:bg-navy-dark">
        ...
        <div className="container px-4 py-6 max-w-3xl mx-auto">
          <div className="auth-required-block">
            ...
            <Button onClick={redirectToAuth} className="bg-teal-600 hover:bg-teal-700 text-white">
              {t('auth.signIn')}
            </Button>
          </div>
        </div>
              ...
              <CardContent className="p-5">
                ...
                {editingEntryId === entry.id ? <>
                    ...
                    <div className="mb-4">
                      ...
                      <Textarea id="notes" name="notes" value={editedEntry?.notes || ""} onChange={handleEditInputChange} className="input-field form-control bg-navy-300" />
                    </div>
                    <div className="flex justify-end gap-2">
                      <Button onClick={cancelEditing} variant="outline" className="border-gray-300 dark:border-gray-600 text-navy-dark dark:text-white bg-navy-100">
                        <X size={16} className="mr-1" />
                        {t('common.cancel')}
                      </Button>
                      <Button onClick={saveEntry} className="text-teal-DEFAULT border border-teal-DEFAULT/30 shadow-sm bg-navy-700 hover:bg-navy-600">
                        {t('journal.save')}
                      </Button>
                    ...
                    <div className="flex justify-end">
                      <Button onClick={() => startEditing(entry.id)} variant="secondary" size="sm" className="bg-airForceBlue-400 hover:bg-airForceBlue-300">
