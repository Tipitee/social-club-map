          ...
          <CardContent className="p-6 rounded-lg">
            ...
            {hasSearched && <div className="mt-4">
                ...
                {searchResults.length === 0 ? <div className="text-center py-8 text-muted-foreground">
                    ...
                    {searchResults.map(club => <div key={club.id} onClick={() => handleClubClick(club.name)} className="p-4 rounded-lg border border-border shadow-md transition-colors cursor-pointer bg-cadetGray-300">
