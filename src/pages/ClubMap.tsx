                  ...
                  <div className="space-y-3 mt-3">
                    {searchResults.map(club => (
                      <div 
                        ...
                        className="p-3 rounded-lg border border-border shadow-md transition-colors cursor-pointer bg-card"
                      >
                          ...
                          <div className="flex-grow">
                            <div className="flex items-center gap-2">
                              ...
                              {!club.membership_status && (
                                <Badge 
                                  variant="outline" 
                                  className="bg-amber-500/10 text-amber-700 dark:text-amber-300 border-amber-300"
                                >
                                  {t('clubs.waitlist')}
                                </Badge>
                              )}
