...
const ClubMapPage: React.FC = () => {
  ...
  return <div className="bg-background min-h-dvh">
      <div className={`container mx-auto px-4 pb-20 ${isIOS && isNative ? 'pt-[env(safe-area-inset-top)]' : 'pt-16'}`}>
          ...
          <CardContent className="p-4 rounded-lg">
            ...
            {hasSearched && <div className="mt-3">
                ...
                {searchResults.length === 0 ? <div className="text-center py-6 text-muted-foreground">
                    ...
                    {searchResults.map(club => <div key={club.id} onClick={() => handleClubClick(club.name)} className="p-3 rounded-lg border border-border shadow-md transition-colors cursor-pointer bg-navy-400">
