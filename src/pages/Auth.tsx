        ...
        <Card className="w-full bg-white/90 dark:bg-navy-light border-gray-200 dark:border-navy-300 shadow-xl backdrop-blur-sm">
          ...
          <Tabs value={tab} onValueChange={setTab} className="w-full">
            <TabsList className="grid grid-cols-2 bg-gray-100 dark:bg-navy-dark mb-4">
              <TabsTrigger value="login" className="text-base data-[state=active]:bg-teal data-[state=active]:text-white dark:data-[state=active]:bg-teal dark:data-[state=active]:text-white">
                {t("auth.signIn")}
              </TabsTrigger>
            ...
            <TabsContent value="login">
              <form onSubmit={handleSubmit}>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        required
                        className="pl-10 py-5 bg-white dark:bg-navy-400 border-gray-300 dark:border-navy-500 text-navy-dark dark:text-white text-base"
                      />
                    </div>
                  </div>
                ...
                <CardFooter className="flex flex-col px-6 pb-6">
                  <Button 
                    type="submit" 
                    className="w-full sm:w-3/4 mx-auto bg-teal hover:bg-teal-dark dark:bg-teal dark:hover:bg-teal-dark text-white py-5 text-lg font-medium" 
